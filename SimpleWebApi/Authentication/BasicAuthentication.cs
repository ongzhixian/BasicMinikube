...
namespace SimpleWebApi.Authentication;
...
public class BasicAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
    ...
    protected override Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        if (clientId != "somelogin" || clientSecret != "somepassword")
        {
        ...
        {
            //AuthenticationType = BasicAuthentication.AuthenticationScheme,
...
{
    public string? AuthenticationType => BasicAuthentication.AuthenticationScheme;
...
public class BasicAuthorizationAttribute : AuthorizeAttribute
{
    ...
    {
        AuthenticationSchemes = BasicAuthentication.AuthenticationScheme;
    }
}