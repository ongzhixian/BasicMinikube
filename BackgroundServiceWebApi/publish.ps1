...
$projectName = "BackgroundServiceWebApi"
$containerImageName = "background-service-web-api"
...
$main = {
	...
	kubectl set image deployment/bg-svc-webapi background-service-web-api=docker.io/library/$nextContainerImageName
